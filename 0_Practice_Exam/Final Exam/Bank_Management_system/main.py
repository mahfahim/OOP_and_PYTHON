...
Admin.create_account("Mahi","mahi23@gmail.com","12345","Faridpur","savings")
            ...
            if name == "admin" and pswd == "123":
                    while True:    
                                ...
                                if op2 == '1':
                                        ...
                                        p = input("Enter press 1 for Bankrupted or  0 for Not Bankrupted : ")
                                        Admin.on_off_bankrupt(p)
               ...
               print("Good Bye !! Islami Bank Bangladesh !!")
               break
